<x-marketplace::shop.layouts>
    ...
    <!-- Breadcrumbs -->
    @section('breadcrumbs')
        <x-marketplace::shop.breadcrumbs name="seller_product_assign" />
    @endSection

    <!-- Assign Product Form -->
    <x-marketplace::shop.form
        :action="route('marketplace.account.products.assign.store', [$id])"
            ...
            <div class="flex flex-col gap-2 w-[360px] max-w-full">
                ...
                <div class="p-5 rounded border">
                    ...
                    <div class="grid gap-2.5 content-start max-w-72">
                        ...
                        <div
                            class="w-full h-[120px] max-w-[120px] max-h-[120px] relative rounded overflow-hidden {{ empty($baseProduct?->images[0]) ? 'border border-dashed border-gray-300 rounded' : '' }}"
                        >
