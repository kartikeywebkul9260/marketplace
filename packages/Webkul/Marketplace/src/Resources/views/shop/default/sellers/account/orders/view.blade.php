<x-marketplace::shop.layouts>
    ...
    <div class="flex gap-4 justify-between items-center max-xl:flex-wrap">
    ...
    <div class="flex gap-2.5 items-center max-xl:flex-wrap mt-4">
    ...
    <div>
        ...
        <div class="flex flex-wrap gap-x-16 gap-y-7 justify-between mt-10 pt-6 border-t border-[#E9E9E9]">
            <!-- Biiling Address -->
