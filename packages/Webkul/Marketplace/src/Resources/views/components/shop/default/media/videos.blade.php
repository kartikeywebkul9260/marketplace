...
@pushOnce('scripts')
            ...
            <div class="flex gap-1">
                ...
                >
                    <div class="flex flex-col items-center">
                        ...
                        <p class="grid text-sm text-gray-800 dark:text-gray-300 font-semibold text-center">
    ...
    <script type="text/x-template" id="v-media-video-item-template">
        <div class="grid justify-items-center h-[120px] max-w-[210px] min-w-[210px] max-h-[120px] relative border border-dashed border-gray-300 dark:border-gray-800 rounded overflow-hidden transition-all hover:border-gray-400 group">
            ...
            <div class="flex flex-col justify-between invisible w-full p-2.5 bg-white dark:bg-gray-900 absolute top-0 bottom-0 opacity-80 transition-all group-hover:visible">
                <!-- Video Name -->
                ...
                <div class="flex justify-between">
                    <!-- Remove Button -->
                    <span
                        class="mp-delete-icon text-2xl p-1.5 rounded-md cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800"
                        @click="remove"
                    ></span>
                    ...
                    <!-- Edit Button -->
                    <label
                        class="mp-upload-icon text-2xl p-1.5 rounded-md cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800"
