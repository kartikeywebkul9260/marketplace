                    ...
                    >
                        ...
                        <div class="flex gap-[10px]">
                            ...
                            <div class="">
                                ...
                                <label
                                    class="mp-uncheckbox-icon text-[24px] peer-checked:mp-checked-icon peer-checked:text-blue-600  cursor-pointer"
                            ...
                            <!-- Image -->
                            <div
                                class="w-full h-15 max-w-15 max-h-15 relative rounded-[4px] overflow-hidden"
        ...
        app.component('v-product-search', {
            ...
            methods: {
                ...
                search() {
                    ...
                    this.$axios.get("{{ route('marketplace.account.products.search_simple') }}", {
                            params: {
